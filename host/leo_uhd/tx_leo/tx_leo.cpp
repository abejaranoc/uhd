...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("file", po::value<std::string>(&file)->default_value("tx_data1"), "name of the file to read binary samples from")
        ...
        ("freq", po::value<double>(&freq)-> default_value(2.805e9) , "RF center frequency in Hz")
        ...
        ("bw", po::value<double>(&bw)-> default_value(2e6), "analog frontend filter bandwidth in Hz")
