...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("nsamps", po::value<size_t>(&total_num_samps)->default_value(20e6), "total number of samples to receive")
        ...
        ("rx-rate", po::value<double>(&rx_rate)->default_value(1e6), "rate of receive incoming samples")
        ("rx-freq", po::value<double>(&rx_freq)->default_value(3e9), "receive RF center frequency in Hz")
