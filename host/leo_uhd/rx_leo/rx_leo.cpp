...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("nsamps", po::value<size_t>(&total_num_samps)->default_value(30e6), "total number of samples to receive")
        ...
        ("rx-rate", po::value<double>(&rx_rate)->default_value(5e5), "rate of receive incoming samples")
        ("rx-freq", po::value<double>(&rx_freq)->default_value(2947e6), "receive RF center frequency in Hz")
        ...
        ("rx-bw", po::value<double>(&rx_bw)->default_value(10e6), "analog receive filter bandwidth in Hz")
