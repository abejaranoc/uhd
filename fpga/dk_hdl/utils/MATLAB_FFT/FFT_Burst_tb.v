// -------------------------------------------------------------
// 
// File Name: hdlsrc\FFTHDLOptimizedExample_Burst\FFT_Burst_tb.v
// Created: 2022-03-29 12:17:11
// 
...
module FFT_Burst_tb;
  ...
  initial
    begin : DataIn_re_fileread
      fp_DataIn_re = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/DataIn_re.dat", "r");
  ...
  initial
    begin : ValidIn_fileread
      fp_ValidIn = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/ValidIn.dat", "r");
  ...
  initial
    begin : DataOut_re_expected_fileread
      fp_DataOut_re_expected = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/DataOut_re_expected.dat", "r");
  ...
  initial
    begin : DataOut_im_expected_fileread
      fp_DataOut_im_expected = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/DataOut_im_expected.dat", "r");
  ...
  initial
    begin : ValidOut_expected_fileread
      fp_ValidOut_expected = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/ValidOut_expected.dat", "r");
  ...
  initial
    begin : Ready_expected_fileread
      fp_Ready_expected = $fopen("/home/user/programs/usrp/uhd/fpga/dk_hdl/utils/MATLAB_FFT/Ready_expected.dat", "r");
